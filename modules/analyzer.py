...
class MarketAnalyzer:
    ...
    def generate_report(self, market_data, news_data, institutional_data=None, prev_report_path=None):
        ...
        8. **報告開場白（重要！）**: 請在報告的最頂端（標題下方），加入以下推廣與免責聲明：
           > 💡 **覺得這份報告有幫助嗎？推薦這個網址給朋友試用看看吧！🚀**
           > ⚠️ 網址功能尚在 Beta 測試中，目前還不完善，分析結果僅供學習與研究參考，不構成任何投資建議。歡迎隨時給予我們回饋！
        9. **語氣**: 專業、簡潔、客觀。
        10. **格式**: 乾淨的 Markdown。
        11. **數字格式（重要！）**: 在報告正文（非表格）中提及關鍵數字時，必須在阿拉伯數字後加上中文括號標註，以確保語音朗讀正確。範例：
